import{R as n,j as r,g as d}from"./index-DiIymZMJ.js";import{B as e}from"./Button-5Efp2OTA.js";const b=i=>i==="sm"?"--bs-btn-padding-y: 0.25rem; --bs-btn-padding-x: 0.5rem; --bs-btn-font-size: 0.875rem; --bs-btn-border-radius: var(--bs-border-radius-sm);":i==="lg"?"--bs-btn-padding-y: 0.5rem; --bs-btn-padding-x: 1rem; --bs-btn-font-size: 1.25rem; --bs-btn-border-radius: var(--bs-border-radius-lg);":"",u=i=>i==="sm"?"padding: 0.25rem 0.5rem; font-size: 0.875rem;":i==="lg"?"padding: 0.5rem 1rem; font-size: 1.25rem;":"",m=i=>i==="sm"?"var(--bs-border-radius-sm)":i==="lg"?"var(--bs-border-radius-lg)":"var(--bs-border-radius)",h=d.div`
  ${i=>b(i.$size)}
  position: relative;
  display: inline-flex;
