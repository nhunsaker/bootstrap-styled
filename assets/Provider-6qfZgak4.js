import{S as c,j as s,c as n,d as t,G as g,R as a}from"./index-C-CN3z2J.js";const h=["primary","secondary","success","danger","warning","info","light","dark"];function d(o,b,e){return h.map(r=>{const l=b[r];return`${e?`--bs-${r}-rgb: ${o.colorRgb[r]};`:""}
