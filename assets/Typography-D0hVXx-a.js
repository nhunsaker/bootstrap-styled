import{R as a,j as n,g as t,f as m}from"./index-DiIymZMJ.js";const c={1:{fluid:"calc(1.625rem + 4.5vw)",fixed:"5rem"},2:{fluid:"calc(1.575rem + 3.9vw)",fixed:"4.5rem"},3:{fluid:"calc(1.525rem + 3.3vw)",fixed:"4rem"},4:{fluid:"calc(1.475rem + 2.7vw)",fixed:"3.5rem"},5:{fluid:"calc(1.425rem + 2.1vw)",fixed:"3rem"},6:{fluid:"calc(1.375rem + 1.5vw)",fixed:"2.5rem"}},d={1:{fluid:"calc(1.375rem + 1.5vw)",fixed:"2.5rem"},2:{fluid:"calc(1.325rem + 0.9vw)",fixed:"2rem"},3:{fluid:"calc(1.3rem + 0.6vw)",fixed:"1.75rem"},4:{fluid:"calc(1.275rem + 0.3vw)",fixed:"1.5rem"},5:{fluid:"1.25rem",fixed:"1.25rem"},6:{fluid:"1rem",fixed:"1rem"}},f=(e,i)=>e===i?m`
        font-size: ${i};
      `:m`
        font-size: ${e};
