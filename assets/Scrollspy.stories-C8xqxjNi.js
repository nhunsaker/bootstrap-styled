import{r as b,j as e,g as p}from"./index-C-CN3z2J.js";function T({ids:r,root:s=null,rootMargin:c="0px 0px -25%",threshold:l=[.1,.5,1]}){const[d,n]=b.useState(r[0]),u=r.join("|"),g=Array.isArray(l)?l.join(","):String(l);return b.useEffect(()=>{if(typeof IntersectionObserver>"u")return;const i=r.map(t=>document.getElementById(t)).filter(t=>t!=null);if(i.length===0)return;const v=s??document.documentElement,o={parentScrollTop:0,visibleEntryTop:0};let x=d;const k=t=>{x!==t&&(x=t,n(t))},$=new IntersectionObserver(t=>{const f=v.scrollTop,j=f>=o.parentScrollTop;o.parentScrollTop=f;for(const w of t){if(!w.isIntersecting)continue;const a=w.target,S=a.offsetTop>=o.visibleEntryTop;if(j&&S){if(o.visibleEntryTop=a.offsetTop,k(a.id),!f)return}else!j&&!S&&(o.visibleEntryTop=a.offsetTop,k(a.id))}},{root:s,rootMargin:c,threshold:l});return i.forEach(t=>$.observe(t)),()=>$.disconnect()},[u,s,c,g]),d}const E=p.ul`
